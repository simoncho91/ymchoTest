...
.doc_sub_table2 tbody tr td{border-right:1px solid #54575f;border-top:1px solid #54575f;padding:3px;font-weight: 500;font-size:5pt;}
									...
									<table class="doc_sub_table2">
										...
										<tbody>
											<tr>
												...
												<td class="td_title_center txt_bold">IngredCode</td>
												<td class="td_title_center txt_bold">INCI Name</td>
												<td class="td_title_center txt_bold">JAPAN name</td>
												<td class="td_title_center txt_bold">Restriction</td>
										...
										<c:forEach items="${list }" var="vo">
											...
											<c:if test="${beforeRawCd ne vo.v_raw_cd}">
												...
												<td class="pif_part3_pop_inci_td">${vo.v_con_cd }</td>
												<td class="pif_part3_pop_inci_td">${vo.v_con_nm_en}</td>
												<td class="pif_part3_pop_inci_td">${vo.v_con_nm_jp}</td>
												<td class="pif_part3_pop_inci_td">${vo.v_restriction}</td>
											<c:if test="${beforeRawCd ne vo.v_raw_cd}">
			...
			<td colspan="4">
				<table class="doc_sub_table" style="width:100%; margin: auto; border: 1px solid #000;">
					...
					<tr>
						...
						<td class="td_title txt_bold" style="background-color: #eeeeee;">JAPAN Name</td>
					</tr>
			<c:forEach items="${allergenList }" var="vo">
				...
				<c:when test="${productInfo.v_part_leaveon_yn == 'Y'}">
					<tr style="background-color: ${vo.v_con_in_per > 0.001 ? 'rgb(152,247,145)' : '' }">
						...
						<td class="pif_part3_pop_inci_td"><span>${vo.v_con_nm_jp }</span></td>
