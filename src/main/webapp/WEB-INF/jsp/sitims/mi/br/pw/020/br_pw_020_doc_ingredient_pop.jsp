...
<!-- 	<tbody> -->
<!-- 		<tr> -->
<%-- 			<td class="last">${cfn:removeHTMLChangeBr(ingredient.v_matrmemo_fr) }</td> --%>
<!-- 		</tr> -->
<!-- 	</tbody> -->
<!-- 	</table> -->
	
	<div class="pd_top10"></div>
	<div class="subtitle">EU</div>
	
	<table class="table_view">
	<tbody>
		<tr>
			<td class="last">${cfn:removeHTMLChangeBr(ingredient.v_matrmemo_eu) }</td>
		</tr>
	</tbody>
	</table>
