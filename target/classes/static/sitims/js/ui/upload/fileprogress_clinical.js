...
function FileProgress(file, targetID) {
	...
	if (this.fileProgressWrapper.html() == null) {
		...
		arrHtml.push("<div id=\""+this.fileProgressID+"\" class=\"progressWrapper\" style=\"margin-bottom: 5px; border: thin; border-style: solid; border-color: #d9e4ff; border-width: thin;\">");
		...
		fnCTappendToCheckbox("#" + this.fileProgressID);
